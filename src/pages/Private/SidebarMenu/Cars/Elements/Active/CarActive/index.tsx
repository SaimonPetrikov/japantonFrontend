...
import CarCard from '../../../../../../../components/CarsCards/Elements/CarCard';
...
import {checkStyles, HeadersStyled, ItemCardStyled, ItemsHeadStyled, ItemStyled, SelectionStyled, SeparateLineStyled } from '../../../Cars.styles';
...
const CarsActive = () => {
  ...
  return (
    <>
      ...
      <ItemStyled>
        <ItemsHeadStyled gridTemplateColumns={'40px 180px 240px 280px 220px 138px 98px 111px'}>
