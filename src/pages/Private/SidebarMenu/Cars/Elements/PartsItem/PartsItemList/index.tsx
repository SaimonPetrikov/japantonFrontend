...
import PartsItemCard from '../../../../../../../components/CarsCards/Elements/PartsItemCard';
...
const CarsPartsItem = () => {
      ...
      return (
        ...
        >
          {partsItemList.partItem.map((elem, index) => (
            <PartsItemCard key={elem.id} partItem={partsItemList?.partItem[index]}/>
          ))}
        </InfiniteScroll>);
    } else {
      return (
  ...
  return (
    <>
      ...
      <ItemStyled>
        <ItemsHeadStyled gridTemplateColumns={'40px 211px 239px 236px 95px 163px 98px 144px auto'}>
