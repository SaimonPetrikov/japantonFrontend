...
import {initialUpdateObj, updateHeaders, updateKeys} from '../../../../../assets/helpers/Cars/CarsUpdate.helpers';

import {BtnsStyled, CarItemsStyled} from './CarItemUpdate.styles';
...
const CarItemUpdate = () => {
  ...
  const updateHandler = () => {
    ...
    carUpdate(updateObj);
    router(`${RouteNames.CARS_ITEM}/${updateObj.id}`);
  };
